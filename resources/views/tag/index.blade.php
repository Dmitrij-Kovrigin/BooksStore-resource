                    ...
                    <div class="card-header__wrap">
                        ...
                        <div class="card-header__wrap__sort">
                            <form action="{{route('tag_index')}}" method="GET">
                                ...
                                <a href="{{route('tag_index')}}" class="btn btn-secondary m-1">RESET</a>
                            </form>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="index-list__content">
                                        <ul class="list-group">
                                            <li class="list-group-item">
                                                <b>Books with tags count:</b>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="index-list__buttons">
                                        <a href="{{route('tag_edit', $tag)}}" class="btn btn-success m-2">EDIT</a>
                                        <button type="submit" class="delete--button btn btn-danger m-2" data-action="{{route('tag_delete', $tag)}}">DELETE</button>
                                    </div>
                                </div>
                            </div>
                            @endforeach
